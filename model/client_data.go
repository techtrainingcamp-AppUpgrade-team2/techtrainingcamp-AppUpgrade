...
type ClientData struct {
	...
	DevicePlatform    string       `form:"device_platform" json:"device_platform"`         //设备平台，Android/iOS
	...
	UpdateVersionCode string       `form:"update_version_code" json:"update_version_code"` //应用小版本，如8.1.4.01
